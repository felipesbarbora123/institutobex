...
// Função helper para enviar mensagem WhatsApp (pode ser chamada diretamente)
export async function sendWhatsAppMessage({ name, phone, courseTitle, amount, message: customMessage }) {
...
// Enviar notificação WhatsApp (endpoint HTTP)
router.post('/send', async (req, res) => {
  try {
    ...
    await query(
      ...
      [req.body.phone || '', '', error.message || 'Erro desconhecido']
    ).catch(err => {
